...
export class HindranceProviderService {
  ...
  public get swade(): Hindrance[] {
    return [
      ...
      new Hindrance('Bad Eyes', 2, '–2 to all Trait rolls dependent on vision. Eyewear negates penalty but have a 50% chance of breaking when the hero suffers trauma. (M)'),
      new Hindrance('Bad Eyes', 1, '–1 to all Trait rolls dependent on vision. Eyewear negates penalty but have a 50% chance of breaking when the hero suffers trauma. (m)'),
      ...
      new Hindrance('Hard of Hearing', 2, 'Completely deaf. Automatic failure to Notice sounds. (M)'),
      new Hindrance('Hard of Hearing', 1, '–4 to Notice sounds (m)'),
      ...
      new Hindrance('Obligation', 2, 'The character has a weekly obligation of 40 hours. (M)'),
      new Hindrance('Obligation', 1, 'The character has a weekly obligation of 20 hours. (m)'),
      ...
      new Hindrance('Pacifist', 2, 'Won’t fight at all. (M)'),
      new Hindrance('Pacifist', 1, 'Fights only in self-defense. (m)'),
      new Hindrance('Phobia', 2, 'The character is afraid of something, and subtracts –2 from all Trait rolls in its presence. (M)'),
      new Hindrance('Phobia', 1, 'The character is afraid of something, and subtracts –1 from all Trait rolls in its presence. (m)'),
      ...
      new Hindrance('Slow', 2, 'Pace –2, –2 to Athletics and rolls to resist Athletics. May not take the Fleet-Footed Edge. (M)', ['Fleet-Footed']),
      new Hindrance('Slow', 1, 'Pace –1, reduce running die one step. May not take the Fleet-Footed Edge. (m)', ['Fleet-Footed']),
      new Hindrance('Suspicious', 2, 'The individual is paranoid. allies subtract 2 when rolling to Support him. (M)'),
      new Hindrance('Suspicious', 1, 'The individual is paranoid. It is a quirk. (m)'),
      new Hindrance('Thin Skinned', 2, 'The character is particularly susceptible to personal attacks. He subtracts 4 when resisting Taunt attacks. (M)'),
      new Hindrance('Thin Skinned', 1, 'The character is particularly susceptible to personal attacks. He subtracts 2 when resisting Taunt attacks. (m)'),
      new Hindrance('Ugly', 2, 'The character is physically unattractive and subtracts 2 from Persuasion rolls. (M)'),
      new Hindrance('Ugly', 1, 'The character is physically unattractive and subtracts 1 from Persuasion rolls. (m)'),
      ...
      new Hindrance('Young', 2, '3 attribute points, 10 skill points, and two extra Bennies per session. (M)'),
      new Hindrance('Young', 1, '4 attribute points and 10 skill points, extra Benny per session. (m)'),
    ];
  }
}
